...
| bs1_p8k_d512 (BS1/P8192/D512) | eager | 4677.88 | 884.81 | 3793.08 / 81.1 | 580.06 | 3213.02 | 195458 | 195233 | 13.7 |
| bs1_p8k_d512 (BS1/P8192/D512) | cudagraph | 995.34 | 885.78 | 109.55 / 11.0 | 24.86 | 84.69 | 196998 | 8869 | 24.7 |
...
| bs1_p8k_d512 (BS1/P8192/D512) | eager | 4588.73 | 1293.51 | 3295.23 / 71.8 | 543.66 | 2751.56 | 195462 | 195237 | 13.7 |
| bs1_p8k_d512 (BS1/P8192/D512) | cudagraph | 1387.83 | 1288.82 | 99.01 / 7.1 | 14.23 | 84.78 | 196998 | 8869 | 16.7 |
...
| bs1_p8k_d512 (BS1/P8192/D512) | eager | 6358.86 | 3749.82 | 2609.05 / 41.0 | 474.59 | 2134.45 | 267246 | 266957 | 14.6 |
| bs1_p8k_d512 (BS1/P8192/D512) | cudagraph | 3855.02 | 3751.53 | 103.49 / 2.7 | 10.74 | 92.75 | 268700 | 8909 | 11.5 |
...
| bs1_p8k_d512 (BS1/P8192/D512) | eager | 6998.73 | 6246.61 | 752.13 / 10.7 | 123.92 | 628.21 | 295970 | 295649 | 14.1 |
| bs1_p8k_d512 (BS1/P8192/D512) | cudagraph | 6412.33 | 6238.30 | 174.03 / 2.7 | 64.10 | 109.93 | 297403 | 8929 | 9.6 |
...
| bs1_p8k_d512 (BS1/P8192/D512) | eager | 19992.95 | 2642.65 | 17350.30 / 86.8 | 1673.72 | 15676.57 | 427338 | 426713 | 9.6 |
| bs1_p8k_d512 (BS1/P8192/D512) | cudagraph | 2767.60 | 2583.37 | 184.23 / 6.7 | 33.18 | 151.06 | 428874 | 8921 | 18.1 |
...
| bs1_p8k_d512 (BS1/P8192/D512) | eager | 18857.03 | 10991.74 | 7865.29 / 41.7 | 790.23 | 7075.06 | 502929 | 502929 | 11.9 |
| bs1_p8k_d512 (BS1/P8192/D512) | cudagraph | 10907.70 | 10770.76 | 136.94 / 1.3 | 7.72 | 129.22 | 503734 | 10897 | 7.8 |
...
| Qwen3-0.6B | bs1_p8k_d512 (BS1/P8192/D512) | 81.1→11.0 | +70.1 | 4678→995 | 4.70× |
...
| Qwen3-1.7B | bs1_p8k_d512 (BS1/P8192/D512) | 71.8→7.1 | +64.7 | 4589→1388 | 3.31× |
...
| Qwen3-8B | bs1_p8k_d512 (BS1/P8192/D512) | 41.0→2.7 | +38.3 | 6359→3855 | 1.65× |
...
| Qwen3-14B | bs1_p8k_d512 (BS1/P8192/D512) | 10.7→2.7 | +8.0 | 6999→6412 | 1.09× |
...
| Qwen3-30B-A3B | bs1_p8k_d512 (BS1/P8192/D512) | 86.8→6.7 | +80.1 | 19993→2768 | 7.22× |
...
| Qwen3.5-27B | bs1_p8k_d512 (BS1/P8192/D512) | 41.7→1.3 | +40.5 | 18857→10908 | 1.73× |
...
### Qwen3-0.6B / cudagraph / bs1_p8k_d512 (BS1/P8192/D512)

| # | Kernel | 次数 | GPU 时间 (ms) |
|---|---|---|---|
| 1 | `nvjet_sm90_tst_64x8_64x16_4x1_v_bz_TNT` | 43008 | 246.586 |
| 2 | `BatchDecodeWithPagedKVCacheKernel` | 14336 | 239.727 |
| 3 | `nvjet_sm90_tst_64x8_64x16_4x1_v_bz_splitK_TNT` | 14336 | 73.154 |
| 4 | `nvjet_sm90_tst_384x8_64x4_2x1_v_bz_TNT` | 513 | 52.841 |
| 5 | `PersistentVariableLengthMergeStatesKernel` | 14336 | 50.503 |
...
### Qwen3-0.6B / eager / bs1_p8k_d512 (BS1/P8192/D512)

| # | Kernel | 次数 | GPU 时间 (ms) |
|---|---|---|---|
| 1 | `nvjet_sm90_tst_64x8_64x16_4x1_v_bz_TNT` | 43008 | 249.011 |
| 2 | `BatchDecodeWithPagedKVCacheKernel` | 14336 | 229.888 |
| 3 | `nvjet_sm90_tst_64x8_64x16_4x1_v_bz_splitK_TNT` | 14336 | 74.054 |
| 4 | `nvjet_sm90_tst_384x8_64x4_2x1_v_bz_TNT` | 513 | 53.018 |
| 5 | `PersistentVariableLengthMergeStatesKernel` | 14336 | 51.214 |
...
### Qwen3-1.7B / cudagraph / bs1_p8k_d512 (BS1/P8192/D512)

| # | Kernel | 次数 | GPU 时间 (ms) |
|---|---|---|---|
| 1 | `nvjet_sm90_tst_64x8_64x16_4x1_v_bz_TNT` | 43008 | 482.819 |
| 2 | `BatchDecodeWithPagedKVCacheKernel` | 14336 | 238.674 |
| 3 | `nvjet_sm90_tst_64x8_64x16_2x1_v_bz_splitK_TNT` | 14336 | 155.577 |
| 4 | `nvjet_sm90_tst_384x8_64x4_2x1_v_bz_TNT` | 513 | 103.890 |
| 5 | `kernel_cutlass_kernel_flashinfernormkernelsfused_add_rmsnormFusedAddRMSNormKernel_object_at__tensorptrbf16gmemalign128o204820481_tensorptrbf16gmemalign128o204820481_tensorptrbf16gmemalign_0` | 28672 | 57.567 |
...
### Qwen3-1.7B / eager / bs1_p8k_d512 (BS1/P8192/D512)

| # | Kernel | 次数 | GPU 时间 (ms) |
|---|---|---|---|
| 1 | `nvjet_sm90_tst_64x8_64x16_4x1_v_bz_TNT` | 43008 | 483.754 |
| 2 | `BatchDecodeWithPagedKVCacheKernel` | 14336 | 229.205 |
| 3 | `nvjet_sm90_tst_64x8_64x16_2x1_v_bz_splitK_TNT` | 14336 | 157.181 |
| 4 | `nvjet_sm90_tst_384x8_64x4_2x1_v_bz_TNT` | 513 | 104.106 |
| 5 | `kernel_cutlass_kernel_flashinfernormkernelsfused_add_rmsnormFusedAddRMSNormKernel_object_at__tensorptrbf16gmemalign128o204820481_tensorptrbf16gmemalign128o204820481_tensorptrbf16gmemalign_0` | 28672 | 61.616 |
...
### Qwen3-14B / cudagraph / bs1_p8k_d512 (BS1/P8192/D512)

| # | Kernel | 次数 | GPU 时间 (ms) |
|---|---|---|---|
| 1 | `nvjet_sm90_tst_384x8_64x4_4x1_v_bz_TNT` | 20473 | 2482.305 |
| 2 | `nvjet_sm90_tst_128x8_64x12_4x1_v_bz_splitK_TNT` | 20473 | 1261.225 |
| 3 | `nvjet_sm90_tst_64x8_64x16_2x1_v_bz_splitK_TNT` | 20473 | 544.911 |
| 4 | `BatchPrefillWithPagedKVCacheKernel` | 20513 | 539.482 |
| 5 | `nvjet_sm90_tst_64x8_64x16_4x1_v_bz_TNT` | 20473 | 415.559 |
...
### Qwen3-14B / eager / bs1_p8k_d512 (BS1/P8192/D512)

| # | Kernel | 次数 | GPU 时间 (ms) |
|---|---|---|---|
| 1 | `nvjet_sm90_tst_384x8_64x4_4x1_v_bz_TNT` | 20480 | 2465.544 |
| 2 | `nvjet_sm90_tst_128x8_64x12_4x1_v_bz_splitK_TNT` | 20480 | 1269.398 |
| 3 | `nvjet_sm90_tst_64x8_64x16_2x1_v_bz_splitK_TNT` | 20480 | 549.762 |
| 4 | `BatchPrefillWithPagedKVCacheKernel` | 20520 | 541.260 |
| 5 | `nvjet_sm90_tst_64x8_64x16_4x1_v_bz_TNT` | 20480 | 414.536 |
...
### Qwen3-30B-A3B / cudagraph / bs1_p8k_d512 (BS1/P8192/D512)

| # | Kernel | 次数 | GPU 时间 (ms) |
|---|---|---|---|
| 1 | `fused_moe_kernel` | 49248 | 848.199 |
| 2 | `BatchPrefillWithPagedKVCacheKernel` | 24624 | 465.962 |
| 3 | `nvjet_sm90_tst_64x8_64x16_4x1_v_bz_TNT` | 24576 | 230.868 |
| 4 | `nvjet_sm90_tst_64x8_64x16_4x1_v_bz_splitK_TNT` | 24576 | 197.887 |
| 5 | `nvjet_sm90_tst_64x8_64x16_2x1_v_bz_TNT` | 24576 | 120.028 |
...
### Qwen3-30B-A3B / eager / bs1_p8k_d512 (BS1/P8192/D512)

| # | Kernel | 次数 | GPU 时间 (ms) |
|---|---|---|---|
| 1 | `fused_moe_kernel` | 49248 | 852.489 |
| 2 | `BatchPrefillWithPagedKVCacheKernel` | 24624 | 466.479 |
| 3 | `nvjet_sm90_tst_64x8_64x16_4x1_v_bz_TNT` | 24576 | 235.275 |
| 4 | `nvjet_sm90_tst_64x8_64x16_4x1_v_bz_splitK_TNT` | 24576 | 203.197 |
| 5 | `nvjet_sm90_tst_64x8_64x16_2x1_v_bz_TNT` | 24576 | 123.453 |
...
### Qwen3-8B / cudagraph / bs1_p8k_d512 (BS1/P8192/D512)

| # | Kernel | 次数 | GPU 时间 (ms) |
|---|---|---|---|
| 1 | `nvjet_sm90_tst_192x8_64x8_2x1_v_bz_TNT` | 18426 | 1259.839 |
| 2 | `nvjet_sm90_tst_64x8_64x16_2x1_v_bz_splitK_TNT` | 36852 | 909.655 |
| 3 | `BatchPrefillWithPagedKVCacheKernel` | 18463 | 465.315 |
| 4 | `nvjet_sm90_tst_64x8_64x16_4x1_v_bz_TNT` | 18427 | 371.676 |
| 5 | `nvjet_sm90_tst_384x8_64x4_2x1_v_bz_TNT` | 512 | 208.867 |
...
### Qwen3-8B / eager / bs1_p8k_d512 (BS1/P8192/D512)

| # | Kernel | 次数 | GPU 时间 (ms) |
|---|---|---|---|
| 1 | `nvjet_sm90_tst_192x8_64x8_2x1_v_bz_TNT` | 18432 | 1260.966 |
| 2 | `nvjet_sm90_tst_64x8_64x16_2x1_v_bz_splitK_TNT` | 36864 | 909.954 |
| 3 | `BatchPrefillWithPagedKVCacheKernel` | 18468 | 461.535 |
| 4 | `nvjet_sm90_tst_64x8_64x16_4x1_v_bz_TNT` | 18432 | 374.028 |
| 5 | `nvjet_sm90_tst_384x8_64x4_2x1_v_bz_TNT` | 513 | 209.841 |
...
### Qwen3.5-27B / cudagraph / bs1_p8k_d512 (BS1/P8192/D512)

| # | Kernel | 次数 | GPU 时间 (ms) |
|---|---|---|---|
| 1 | `nvjet_sm90_tst_384x8_64x4_4x1_v_bz_TNT` | 32754 | 3967.235 |
| 2 | `nvjet_sm90_tst_128x8_64x12_4x1_v_bz_splitK_TNT` | 32753 | 2025.973 |
| 3 | `nvjet_sm90_tst_128x8_64x12_2x1_v_bz_TNT` | 24566 | 1397.169 |
| 4 | `nvjet_sm90_tst_64x8_64x16_2x1_v_bz_splitK_TNT` | 24566 | 1257.745 |
| 5 | `nvjet_sm90_tst_64x8_64x16_4x1_v_bz_TNT` | 32754 | 811.122 |
...
### Qwen3.5-27B / eager / bs1_p8k_d512 (BS1/P8192/D512)

| # | Kernel | 次数 | GPU 时间 (ms) |
|---|---|---|---|
| 1 | `nvjet_sm90_tst_384x8_64x4_4x1_v_bz_TNT` | 32768 | 3995.560 |
| 2 | `nvjet_sm90_tst_128x8_64x12_4x1_v_bz_splitK_TNT` | 32768 | 2032.214 |
| 3 | `nvjet_sm90_tst_128x8_64x12_2x1_v_bz_TNT` | 24576 | 1389.831 |
| 4 | `nvjet_sm90_tst_64x8_64x16_4x1_v_bz_TNT` | 32768 | 810.124 |
| 5 | `nvjet_sm90_tst_320x128_64x3_1x2_h_bz_coopB_TNT` | 208 | 509.141 |
